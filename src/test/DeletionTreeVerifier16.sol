...
/// @dev test deletion verifier for tree depth 16 batch size 8
...
contract Verifier is ITreeVerifier {
    ...
    uint256 constant ALPHA_X =
        10540806559887167104588299892241621164255487150461496341626858664281664558273;
    uint256 constant ALPHA_Y =
        18696534755308846201677397222792953217528992421163095056941057317509629524722;

    // Groth16 beta point in G2 in powers of i
    uint256 constant BETA_NEG_X_0 =
        9289144700177602508224796928305680819301212642031268209898370879595438760917;
    uint256 constant BETA_NEG_X_1 =
        10547839143610067056656195135986672966679578259812908443118403685682429861701;
    uint256 constant BETA_NEG_Y_0 =
        12915174887173266773990929270621008261886710141330627051375005843032324032816;
    uint256 constant BETA_NEG_Y_1 =
        20204556387398089691578608866734867938413428713768226934160981536705045926684;
    ...
    uint256 constant GAMMA_NEG_X_1 =
        12148123627061259167145600433069418819234101862686655936951485568840483717123;
    ...
    uint256 constant DELTA_NEG_X_0 =
        1634881525453069381539064669198838164371392344721377194711591834696682352477;
    uint256 constant DELTA_NEG_X_1 =
        17279327023445589453594845467776134123782766121800267509419424589125110740187;
    uint256 constant DELTA_NEG_Y_0 =
        11432830246305367590277540894794860588641953149336980701683372253417473334750;
    uint256 constant DELTA_NEG_Y_1 =
        4004758155600074163048436555321639796581387612468627300293241737049808612532;

    // Constant and public input points
    uint256 constant CONSTANT_X =
        7065344469851661926793643372215217621315658305837861579101548147761825653088;
    uint256 constant CONSTANT_Y =
        3816842911808951106840635623036133479452547290738636365883439290420360457712;
    uint256 constant PUB_0_X =
        3600420742132324519200509028486624821285996242068377631973021819080430036637;
    uint256 constant PUB_0_Y =
        372418442062690161950901896514875127229125198024957013636072554100336848194;
    ...
    function verifyCompressedProof(uint256[4] calldata compressedProof, uint256[1] calldata input)
        public
        view
    {
